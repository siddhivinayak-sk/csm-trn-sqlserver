...
public enum Exceptions {
	...
	E0026(HttpStatus.BAD_REQUEST, "0026", "exception.0026", "Invlid account number"),
	E0027(HttpStatus.BAD_REQUEST, "0027", "exception.0027", "Incorrect amount passed"),
	E0028(HttpStatus.BAD_REQUEST, "0028", "exception.0028", "Invlid TO account number"),
	E0029(HttpStatus.BAD_REQUEST, "0029", "exception.0029", "Invlid FROM account number"),
	E0030(HttpStatus.BAD_REQUEST, "0030", "exception.0030", "Account inactive"),
	E0031(HttpStatus.BAD_REQUEST, "0031", "exception.0031", "In sufficient balance"),
	E0032(HttpStatus.BAD_REQUEST, "0032", "exception.0032", "Inactive customer"),
	E0033(HttpStatus.BAD_REQUEST, "0033", "exception.0033", "Account TO inactive"),
	E0034(HttpStatus.BAD_REQUEST, "0034", "exception.0034", "Account FROM inactive"),
	E0035(HttpStatus.BAD_REQUEST, "0035", "exception.0035", "Inactive TO customer"),
	E0036(HttpStatus.BAD_REQUEST, "0036", "exception.0036", "Inactive FROM customer"),
	E0037(HttpStatus.BAD_REQUEST, "0037", "exception.0037", "Invalid customer"),
	E0038(HttpStatus.BAD_REQUEST, "0038", "exception.0038", "Transaction failed"),
	E0039(HttpStatus.BAD_REQUEST, "0029", "exception.0029", "Connectivity issue")
	;
